...
- requests to network origins outside the documented scope (the configured AI endpoint plus YouTube and Bilibili caption endpoints);
...
- The extension uses your browser's own Bilibili login to fetch subtitles. Treat your Bilibili account credentials as you normally would; the extension does not read or store your password.
